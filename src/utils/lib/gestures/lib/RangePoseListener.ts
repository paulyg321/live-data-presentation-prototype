...
export type RangePoseListenerArgs = GestureListenerConstructorArgs;

export class RangePoseListener extends GestureListener {
  constructor({
    handsToTrack = {
  ...
  private publishToSubject() {
    ...
    const foreshadowingArea = this.getRangeDataFromState();
